(function (global) {
    ...
    function renderUidCell(row) {
        var uidHtml = global.AdminCopyChip ? global.AdminCopyChip.uid(row.uid) :
            '<span class="font-black">' + row.uid + '</span>';
        return '<div>' + uidHtml + '<span class="virtual-badge mt-1 inline-block">虚拟</span></div>';
    }
