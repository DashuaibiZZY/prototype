...
- **样式**：蓝色底色卡片，白色文字，位于等级路径右侧

- **文案**：

    - 标题：`ForX 合伙人计划`（原「ForX 大使計劃」）

    - 描述：`有社区影响力或交易资源？申请解锁 40% 起返佣与专属权益。`

- **行为**：点击「立即申请 →」进入子页面 **`合伙人计划.html`**（同站点路由，非外链表单）

---

#### 2\.4\.1 ForX 合伙人计划 · 子页面

**原型**：[合伙人计划.html](https://dashuaibizzy.github.io/prototype/perp_dex/%E5%90%88%E4%BC%99%E4%BA%BA%E8%AE%A1%E5%88%92.html)

**页面结构**（自上而下）：

1. **页头**：标题「ForX 合伙人计划」· 一句话价值主张（把社区影响力变成持续收益）；**无**「返回邀请返佣」按钮

2. **计划说明**：面向 KOL / 交易社区主理人 / 高月成交额渠道；通过后享受 40% 起返佣、现金与代币奖励、NFT 等专属权益

3. **申请区**（三态）：

| 状态 | 展示 |
|---|---|
| **未登录** | 说明文案 + 按钮「立即申请」→ **当前页弹出**连接钱包引导（同全站登录流程；无独立路由状态） |
| **已登录 · 普通用户** | 完整申请表单 + 「立即申请」提交 |
| **已登录 · 已是合伙人** | **不可提交**；展示提示并引导前往「合伙人管理中心」（含任意层级：一级 / 二级 / 三级…） |

> **注意事项**：已是 ForX 合伙人（任意层级代理）的账号**无法**提交合伙人计划申请。
...
| 社交账号粉丝数 | 必填 · 仅整数 |
| 社区管理人数 | 必填 · 仅整数 |
| 团队月交易额预估（USDT） | 必填 · 仅整数 |
| 可立刻联系您的联系方式 | **必填** · 先选渠道（Telegram / Line / Discord），再填写具体账号 |
| X（Twitter） | 选填 |
| YouTube | 选填 |
| 社区与推广经验 | 选填 · 多行；可分享最满意合作案例；也可在补充材料上传证明 |
| 补充材料 | 选填 · **最多 4 个文件** · 上传渠道证明等材料，**可加速审核**；支持 PNG / JPG、Word、PDF、Excel |

4. **权益说明**：「您可以获得什么？」六卡 — 行业顶级返佣 / 1.5x 积分加成 / 代币空投 / 现金奖金池 / NFT 空投 / 线下会场席位

5. **FAQ**：「什么是 ForX 合伙人计划？」常见问答

**提交后**：申请进入后台「合伙人申请管理」队列，由运营审核并可一键「设置成一级代理」。
