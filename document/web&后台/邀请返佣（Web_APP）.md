...
1. **收益结算与锁定（优先级最高）：**
    ...
    - 抓取全站用户在 昨日00:00 至 今日00:00 之间产生交易的所有邀请关系。
...
3. **等级更新：**
    ...
    - 缓冲期机制：
        ...
        - 保护期内：
            ...
            - 系统每日 00:00 重新评估，若仍不满足则继续消耗缓冲期，若重新达标则缓冲期自动清除，等级不变。
...
- 6月8日 00:00，系统结算：将 Bob 的交易按 6月7日 10% 的比例锁定 $100 待结算返佣。
