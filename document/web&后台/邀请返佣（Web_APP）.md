...
| 区块 | 说明 |
|---|---|
| **数据预览** | 列表筛选结果联动汇总：邀请用户数、累计已返佣、待结算返佣、冻结账户数 |
| **查询筛选** | UID / 钱包 / 邮箱模糊搜索；邀请等级；结算状态 |
| **用户列表** | 普通用户返佣数据明细，10 条/页 |
...
| UID | 可复制 |
| 钱包地址 / 邮箱 | 优先展示邮箱，否则钱包 |
| 邀请等级 | Lv 0–3，对应 §等级配置表 |
| 返佣比例 | 当前等级手续费返佣比例 |
| 邀请好友人数 | 直邀好友总数 |
| 活跃好友数 | 过去 30 日交易额 ≥ $10,000 的直邀好友数 |
| 下级交易额 | 直邀好友累计交易额（USDT 折算） |
| 下级手续费 | 直邀好友累计 gross 手续费 |
| 累计已返佣金额 | 历史已发放至用户账户的返佣合计 |
| 待结算返佣 | 已锁定、尚未发放的待结算收益 |
| 结算状态 | **正常** / **冻结**（冻结时暂停发放，待结算仍可运营回收） |
| 操作 | **回收待结算**（待结算返佣 > 0 时可用） |
