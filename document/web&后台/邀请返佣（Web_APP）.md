...
|列名|说明|格式/视觉|
|---|---|---|
|錢包地址|好友地址脱敏|前 6 位 \+ … \+ 后 4 位（如 `0xd593...2Dd2`），加粗黑色|
...
- **弹窗内容**：
    ...
    - 注册引导文案（ForX 平台价值宣传 + 连接钱包注册、邀请权益自动生效说明），示例：
        ...
        > 体验 ForX 新一代永续合约——毫秒级撮合、深度流动性与专业级交易 tools，助您把握每一波行情。连接钱包完成注册，邀请权益即刻生效。
...
- 每个好友条目为一张独立卡片，包含：
    ...
    - **头部**：钱包地址（脱敏，前 6 位 … 后 4 位，加粗）\+ 注册时间（`YYYY-MM-DD`）
